// Converted from lib/constants/errors.js
...
export enum ErrorsEnum {
  ...
  HA_ERR_ROW_FORMAT_CHANGED = 202,
  HA_ERR_NO_WAIT_LOCK = 203,
  HA_ERR_DISK_FULL_NOWAIT = 204,
  HA_ERR_NO_SESSION_TEMP = 205,
  HA_ERR_WRONG_TABLE_NAME = 206,
  HA_ERR_TOO_LONG_PATH = 207,
  HA_ERR_SAMPLING_INIT_FAILED = 208,
  HA_ERR_FTS_TOO_MANY_NESTED_EXP = 209,
  ER_HASHCHK = 1000,
  ER_NISAMCHK = 1001,
  ER_NO = 1002,
  ER_YES = 1003,
  ...
  ER_GTID_UNSAFE_CREATE_DROP_TEMP_TABLE_IN_TRANSACTION = 1787,
  ...
  // ER_XA_REPLICATION_FILTERS = 3227, // re-declared
  ER_CANT_OPEN_ERROR_LOG = 3228,
  // ER_GROUPING_ON_TIMESTAMP_IN_DST = 3229, // re-declared
  ER_CANT_START_SERVER_NAMED_PIPE = 3230,
  ER_WRITE_SET_EXCEEDS_LIMIT = 3231,
  ER_DEPRECATED_TLS_VERSION_SESSION_57 = 3232,
  ER_WARN_DEPRECATED_TLS_VERSION_57 = 3233,
  ER_WARN_WRONG_NATIVE_TABLE_STRUCTURE = 3234,
  ...
  ER_XA_CANT_CREATE_MDL_BACKUP = 3749,
  ...
  ER_AUDIT_LOG_PASSWORD_HAS_BEEN_COPIED = 3915,
